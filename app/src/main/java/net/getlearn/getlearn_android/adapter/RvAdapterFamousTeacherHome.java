...
public class RvAdapterFamousTeacherHome extends RecyclerView.Adapter<RvAdapterFamousTeacherHome.ViewHolder>{

    private Context mContext;
    private FamousTeacherModelHome.DatabeanX mData;
    private LayoutInflater mInflater;

    public RvAdapterFamousTeacherHome(Context context,FamousTeacherModelHome.DatabeanX data) {
        mContext = context;
        mData = data;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_famous_teacher_home,viewGroup,false);
