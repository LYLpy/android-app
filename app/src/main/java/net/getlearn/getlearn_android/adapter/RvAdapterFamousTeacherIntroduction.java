...
public class RvAdapterFamousTeacherIntroduction extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public RvAdapterFamousTeacherIntroduction(Context context, FamousTeacherIntroductionModel.Databean data) {
        mContext = context;
        mData = data;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        if (viewType == Constants.ITEM_TYPE_HEADER){
            ...
            View itemView = inflater.inflate(R.layout.item_famous_teacher_introduction, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (viewType == Constants.ITEM_TYPE_HEADER){
            ...
            RequestOptions options = new RequestOptions().bitmapTransform(roundedCorners)
                    ...
                    .diskCacheStrategy(DiskCacheStrategy.RESOURCE)//磁盘缓存
                    .skipMemoryCache(false);//内存缓存
            Glide.with(mContext).load(coursebean.getIcon()).apply(options).into(holder.ivIcon);
    ...
    public class ItemHolder extends RecyclerView.ViewHolder{
        ...
        public TextView tvViews;//XXX人已学，多少人看过
