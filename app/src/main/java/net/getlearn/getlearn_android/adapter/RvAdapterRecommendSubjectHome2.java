...
public class RvAdapterRecommendSubjectHome2 extends RecyclerView.Adapter<RvAdapterRecommendSubjectHome2.Holder>{

    private LayoutInflater inflater;
    private Context mContext;
    private RecommendSubjectHomeModel.DatabeanX mData;
    private CrazyShadow crazyShadow;
    public RvAdapterRecommendSubjectHome2(Context context, RecommendSubjectHomeModel.DatabeanX datas) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, int i) {
        ...
        holder.tvTitle.setText(String.valueOf("        " + name));
...
//        Glide.with(mContext).load(R.drawable.img01).apply(options).into(holder.ivIcon);
        holder.tvAmount.setText("名师辅导·免费试看·共" + mData.getData().get(i).getOkResCount() + "课");
